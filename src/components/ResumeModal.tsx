                    ...
                    <div className="space-y-4">
                      <div className="border-l-2 border-purple-500 pl-4 space-y-1">
                        ...
                        <div className="pt-1 flex gap-3 text-xs">
                          <a href="https://rail-line-klvoma335-nikhil-agrahari.vercel.app/" target="_blank" rel="noreferrer" className="text-purple-600 font-semibold hover:underline flex items-center gap-1">
